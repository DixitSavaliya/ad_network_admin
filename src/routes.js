...
const AdverTiser = React.lazy(() => import('./views/Advertiser/advertiser'));
const Publisher = React.lazy(() => import('./views/Publisher/publisher'));
...
const UserRight = React.lazy(() => import('./views/UserRight/userright'));
const UserRoleToRight = React.lazy(() => import('./views/UserRoleToRight/userroletoright'));
